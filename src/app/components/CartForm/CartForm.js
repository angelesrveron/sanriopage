        ...
        {({ isSubmitting, errors, touched }) => (
          ...
          <div className="flex  flex-col">
            <div className="mb-6">
              ...
              <Field className={`${styles["formulario-texto"]} `} name="firstName" placeholder="Jane" validate={firstName} />
              {errors.firstName && touched.firstName && <p className=" text-xs text-red-700">*Completar</p>}
            </div>
            <div className="mb-6">
              <label className="text-xl font-bold mr-1" htmlFor="lastName">Apellido:</label>
              <Field className={`${styles["formulario-texto"]} `} name="lastName" placeholder="Doe" validate={lastName} />
              {errors.lastName && touched.lastName && <p className=" text-xs text-red-700">*Completar</p>}
            </div>
          </div>

          <div className="mb-6">
            <label className="text-xl font-bold mr-8" htmlFor="email">Email:</label>
            <Field  className={`${styles["formulario-texto"]} `} name="email" placeholder="jane@acme.com" type="email" validate={validateEmail} />
            {errors.email && touched.email && <p className=" text-xs text-red-700">*Completar con un email</p>}
          </div>
          ...
          <div className="mb-6">
            ...
            {errors.phone && touched.phone && <p className=" text-xs text-red-700">Error de numero</p>}
          </div>
